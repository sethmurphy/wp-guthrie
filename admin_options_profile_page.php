...
<table id="profile-fields">
	...
	<?php foreach ($profile_field_instances as $field): ?>
		<tr class="profile-field-instance" id="field-instance_<?php echo( $field->id ); ?>" >
			...
			<td><div tabindex="1" id="<?php echo( $field->tag ); ?>_<?php echo( $field->id ); ?>" name="<?php echo( $field->tag ); ?>_<?php echo( $field->id ); ?>" class="cell-content-wrapper profile-field"><?php echo( stripslashes( $field->value ) ); ?></div></td>
			<td>
